...
Creates a quick reference card for developers
"""
...
def generate_quick_ref():
    # Save to file
    with open("./docs/QUICK_REFERENCE.md", "w") as f:
        f.write(QUICK_REFERENCE)
    
    with open("./QUICK_REFERENCE.md", "w") as f:
        f.write(QUICK_REFERENCE)
    
    print("✓ Quick reference saved to ./QUICK_REFERENCE.md")
    print("✓ Quick reference saved to ./docs/QUICK_REFERENCE.md")
