...
SOURCE_CLASS_MAPPING = {
    'data/archive/Image_brokenphones': 'Repair',
    'data/archive/Image_phones': 'Recycle',
    'data/archive-2/good': 'Reuse',
    'data/archive-2/oil': 'Refurbish',
    'data/archive-2/stain': 'Refurbish',
    'data/archive-2/scratch': 'Repair'
}

SKIP_FOLDERS = {'data/archive-2/ground_truth_1', 'data/archive-2/ground_truth_2'}
...
def build_dataset(output_root: Path, train_fraction: float = 0.8, seed: int = 42, force: bool = False):
    ...
    for rel_src, class_name in SOURCE_CLASS_MAPPING.items():
        ...
        if "ground_truth_1" in rel_src or "ground_truth_2" in rel_src:
            continue
